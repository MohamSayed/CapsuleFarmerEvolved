        ...
        try:
            ...
            if "multifactor" in resJson.get("type", ""):
                if (imapserver != ""):
                    ...
                    self.stats.updateStatus(self.account, f"[green]FETCHED 2FA CODE[/green]" if self.raw else "FETCHED 2FA CODE")
                    ...
                    self.stats.updateStatus(self.account, f"[green]CODE SENT[/green]" if self.raw else "CODE SENT")
